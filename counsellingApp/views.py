...
def superadminPage(request, pk):
    ...
    return render(request, 'app/super.html', {'profile': profile,
...
def adminPage(request, pk):
    ...
    return render(request, 'app/admin.html', {'profile': profile,
                                              'notification': notification,
                                              'index': index,
                                              'admin': admin,
                                              'counsellor':  counsellor,
...
def settingsPage(request, pk):
    ...
    return render(request, 'app/settings.html', {'profile': profile,
                                                 'notification': notification,
                                                 'index': index,
                                                 'admin': admin,
                                                 'counsellor':  counsellor,
...
def notificationPage(request, pk):
    ...
    return render(request, 'app/notification.html', {'profile': profile,
                                                     'notification': notification,
                                                     'index': index,
                                                     'admin': admin,
                                                     'counsellor':  counsellor,
